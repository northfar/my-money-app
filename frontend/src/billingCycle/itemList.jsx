...
class ItemList extends Component{
    ...
    add(index, item = {}){
        if(!this.props.readOnly){
            //ArrayInsert - insere valores no formulário dinamicamente
            //Parâmetros: id do formulário, nome do campo, índice e valor
                ...
                <tr key={index}>
                    ...
                    <td>
                        ...
                        onClick={() => this.add(index + 1, item)} />
                         <IconButton style='danger' icon='times' type='button' 
